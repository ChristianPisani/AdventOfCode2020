...
namespace AdventOfCode2020.Day7 {
    public static class Input {
        public static List<string> Values = @"drab tan bags contain 4 clear gold bags.
...
dim chartreuse bags contain 3 shiny gold bags, 2 mirrored olive bags.".Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
    }
}
